...
- **File path**: `/Users/wanxin/Downloads/Mcap/Airbot数据采集/zd-20260205/1.mcap`

## Topics (Channels)

| Channel ID | Topic | Message Encoding | Schema ID | Schema Name | Message Count |
| --- | --- | --- | --- | --- | --- |
| 1 | `/robot/arm_left_lead/joint_states` | `cdr` | 1 | `sensor_msgs/msg/JointState` | 3035 |
| 2 | `/robot/arm_left_follow/joint_states` | `cdr` | 1 | `sensor_msgs/msg/JointState` | 3035 |
| 3 | `/robot/arm_right_lead/joint_states` | `cdr` | 1 | `sensor_msgs/msg/JointState` | 3035 |
| 4 | `/robot/arm_right_follow/joint_states` | `cdr` | 1 | `sensor_msgs/msg/JointState` | 3035 |
...
| `/env_camera/color/image_raw` | `"/robot/env_camera/color/image_raw"` |
...
| `/left_camera/color/image_raw` | `"/robot/left_camera/color/image_raw"` |
...
| `/right_camera/color/image_raw` | `"/robot/right_camera/color/image_raw"` |
